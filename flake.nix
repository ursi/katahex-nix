{ inputs =
    { katago = { url = "github:hzyhhzy/KataGo/Hex2022"; flake = false; };
      lizzyzy = { url = "https://drive.google.com/u/0/uc?id=1qbTTmPFiUkM_346DeKS1E9gJR-roNH63&export=download&confirm=t&uuid=101373af-a46f-4794-a1c7-151c1f5fe59a&at=ALgDtszvi-tg4S5aGQ9t7AnXcflU:1676397446078"; flake = false; };
      make-shell.url = "github:ursi/nix-make-shell/1";
      model = { url = "https://drive.google.com/u/0/uc?id=1xMvP_75xgo0271nQbmlAJ40rvpKiFTgP&export=download&confirm=t&uuid=0fd3460e-dc4e-4e7d-81a5-ab11c1cf1772&at=ALgDtswWGdmlMCoyYDj55UXZkQQ5:1676420358456"; flake = false; };
         ...
         let
           ...
           lizzieyzy =
             p.runCommand "lizzieyzy" {}
               ''
               ${p.unzip}/bin/unzip ${inputs.lizzyzy}
             ...
             make-shell
               { packages =
                 ...
                 setup =
                   ...
                   cp -nr ${lizzieyzy}/. .
                   chmod -R u+w .
                   ln -fs ${inputs.model} weights/katahex_model_20220618.bin.gz
